...
기본 제공 함수 인터페이스 java8 -  다양한 범용 함수 인터페이스를 기본으로 제공.
...
익명 클래스(+변수포획 : 익명클래스 밖의 변수를 사용하기) = 자바식 클로저(Closure)
...
http://www.slideshare.net/gyumee/java-8-lambda-35352385?related=1
Java 8 in Action
